      ...
      <div className="bg-white aspect-modal w-[90%] md:w-auto md:h-[90%] mx-auto rounded-lg shadow-lg overflow-hidden">
        <div className="p-5 bg-modal-bg bg-contain h-full">
          <div className="relative w-3/4 flex flex-col items-center mx-auto">
            <button onClick={() => onClose()} className="text-xs md:text-lg mt-3 md:mt-8 font-gilda text-custom-pink-transparent border border-custom-pink-transparent rounded-md p-1 md:p-2 hover:bg-custom-pink-transparent">Ugrás az oldalra</button>
