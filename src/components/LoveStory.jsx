  ...
  return (
    <section id="love-story" className="bg-white">
      <div className="pt-20 pb-28 flex flex-col gap-4 items-center">
        <h1 className="relative uppercase font-gilda text-3xl sm:text-4xl m-4 text-custom-pink">
          <img
        ...
        <div className="mb-8">
          <div className="flex justify-center font-gilda font-medium text-[11px] sm:text-xs md:text-lg gap-5 md:gap-16 uppercase text-gray-500">
            <span
